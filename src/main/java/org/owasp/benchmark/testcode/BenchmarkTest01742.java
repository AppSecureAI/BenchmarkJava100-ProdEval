...
public class BenchmarkTest01742 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            byte[] resultWithIv = new byte[ivBytes.length + result.length];
            System.arraycopy(ivBytes, 0, resultWithIv, 0, ivBytes.length);
            System.arraycopy(result, 0, resultWithIv, ivBytes.length, result.length);
            ...
            fw.write(
                    "secret_value="
                            + org.owasp.esapi.ESAPI.encoder().encodeForBase64(resultWithIv, true)
                            + "
");
            fw.close();
            response.getWriter()
